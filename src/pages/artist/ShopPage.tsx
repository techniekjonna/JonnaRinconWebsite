    ...
    <ArtistLayout>
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-white/40 mt-2">Browse and license high-quality beats by Jonna Rincon</p>
        </div>
        ...
        <div className="bg-white/[0.08] border border-white/[0.06] rounded-xl p-6">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <input
              ...
              className="bg-white/[0.06] border border-white/[0.08] rounded-lg px-4 py-2 text-white focus:outline-none focus:border-orange-500"
            />
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {beats.map((beat) => (
              <div
                key={beat.id}
                className="bg-white/[0.08] border border-white/[0.06] rounded-xl overflow-hidden hover:border-orange-500/50 transition-all hover:transform hover:scale-105"
              >
                {/* Beat Artwork */}
                <div className="relative">
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 hover:opacity-100 transition-opacity flex items-center justify-center">
                    <button className="bg-orange-600 hover:bg-orange-700 rounded-full p-4 transition-all hover:scale-110">
                ...
                <div className="p-4">
                  ...
                  <div className="flex justify-between items-center pt-3 border-t border-white/[0.06]">
                    ...
                    <Link
                      to={`/artist/shop/${beat.id}`}
                      className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-orange-700 hover:to-red-700 px-4 py-2 rounded-lg text-white font-medium transition-all"
                    >
                      View Beat
                    </Link>
                  </div>
